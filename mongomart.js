...
MongoClient.connect('mongodb://localhost:27017/mongomart', function(err, db) {
    //connect olunca callback olarak varsa hata ve db nesnesini döndürüyor
    //db nesnesinden yeniden bağlantı yapmadan farklı collectionlara veya database'lere gidebiliriz
    "use strict";
    ...
    router.get("/", function(req, res) {
        ...
        items.getCategories(function(kategoriler) {
...
//                console.log(relatedItems);
    ...
    router.post("/user/:userId/cart/items/:itemId", function(req, res) {
        ...
        //render fonksiyonunu hazırladı, cart'ı hazırladıktan sonra kullanacak
        var renderCart = function(userCart) {
            //sepetteki toplam tutarı hesaplıyor
            var total = cartTotal(userCart);
            res.render("cart",
                       {
                           userId: userId,
